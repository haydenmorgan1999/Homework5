...
The best performing model is Model 2. *explanation here*
...
In the context of this data set/problem, this means that the logistic regression model Model 2 *more stuff here*
...
numer of true negatives / (number of true negatives + number of false positives) = 
